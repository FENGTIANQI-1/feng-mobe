      ...
      <el-tabs type="border-card" v-model="tabIndex">
        ...
        <el-tab-pane name="two" label="技能" class="tab-pane-two">
          ...
          <el-row type="flex" style="flex-wrap: wrap" :gutter="30">
            ...
            >
              ...
              <el-form-item>
                <el-button type="danger" size="small" @click="delSkill(index)"
                  >删除</el-button
                >
              </el-form-item>
            </el-col>
        ...
        <el-tab-pane name="three" label="皮肤" class="tab-pane-three">
          ...
          <el-row type="flex" style="flex-wrap: wrap" :gutter="30">
            <el-col
              :md="12"
              v-for="(item, index) in model.skins"
              :key="index"
              style="margin-top: 30px"
            >
              <el-form-item label="名称">
              ...
              <el-form-item label="设计图">
                ...
                >
                  ...
                  <i
                    ...
                    @click="uploadSkinIndex = index"
                  ></i>
                </el-upload>
              </el-form-item>
              <el-form-item>
                <el-button type="danger" size="small" @click="delSkin(index)"
                  >删除</el-button
                >
              </el-form-item>
            </el-col>
        ...
        <el-tab-pane name="four" label="英雄关系" class="tab-pane-four">
            ...
            >
              ...
              <el-form-item>
                <el-button
                  type="danger"
                  size="small"
                  @click="delHeroRelate(index, 'partners')"
                  >删除</el-button
                >
              </el-form-item>
            </el-col>
          ...
          <el-row type="flex" style="flex-wrap: wrap" :gutter="30">
            <el-col
              :md="12"
              v-for="(item, index) in model.enemies"
              :key="index"
              style="margin-top: 30px"
            >
              <el-form-item label="名称">
              ...
              <el-form-item>
                <el-button
                  type="danger"
                  size="small"
                  @click="delHeroRelate(index, 'enemies')"
                  >删除</el-button
                >
              </el-form-item>
            </el-col>
          ...
          <el-row type="flex" style="flex-wrap: wrap" :gutter="30">
            <el-col
              :md="12"
              v-for="(item, index) in model.preies"
              :key="index"
              style="margin-top: 30px"
            >
              <el-form-item label="名称">
              ...
              <el-form-item>
                <el-button
                  type="danger"
                  size="small"
                  @click="delHeroRelate(index, 'preies')"
                  >删除</el-button
                >
              </el-form-item>
            </el-col>
        ...
        <el-tab-pane name="five" label="英雄攻略" class="tab-pane-five">
          ...
          <el-row type="flex" style="flex-wrap: wrap" :gutter="30">
            <el-col
              :md="12"
              v-for="(item, index) in model.strategies"
              :key="index"
              style="margin-top: 30px"
            >
              ...
              <el-form-item label="封面">
                ...
                >
                  ...
                  <i
                    v-else
                    class="el-icon-plus banner-uploader-icon"
                    @click="uploadStrategyIndex = index"
                  ></i>
                </el-upload>
              </el-form-item>
...
#hero-edit {
  ...
  .tab-pane-two, .tab-pane-three, .tab-pane-four, .tab-pane-five {
    .el-form-item:last-child {
      text-align: right;
      margin-bottom: 0;
    }
